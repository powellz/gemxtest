...
make run_hw GEMX_ddrWidth=32 GEMX_XddrWidth=16 GEMX_keepMacBits=1 GEMX_argInstrWidth=1 GEMX_numKernels=1 GEMX_gemmMBlocks=4 GEMX_gemmKBlocks=4 GEMX_gemmNBlocks=1 GEMX_splitMesh=1 GEMX_part=vcu1525 GEN_BIN_PROGRAM=" fcn 512 512 128 512 128 128 128 1 0 1 0 A0 B0 C0 Bias0 fcn 128 128 128 128 128 128 128 1 0 1 0 A1 B1 C1 Bias1" 
popd
