...
nice out_host/gemx_api_spmv.exe out_hw/gemx.xclbin 159936 159936 500000 |& tee log-2.txt

logs="$logs log-diag16k.txt log-raefsky3.txt log-stomach.txt log-torso3.txt log-Rucci1.txt log-1.txt log-2.txt"
