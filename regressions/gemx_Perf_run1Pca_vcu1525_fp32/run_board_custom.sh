...
nice out_host/gemx_api_pca.exe out_hw/gemx.xclbin 0 0 0 8 ../data/spmv/dawson5.mtx A0 B0 C0 51552 51552 531160 8 none A0 C0 C1 0 0 0 8 ../data/spmv/bcsstk16.mtx A2 B2 C2 4896 4896 147632 8 none A2 C2 C3 | tee log-multiInstr1.txt

logs="log-multiInstr.txt log-multiInstr1.txt"
