...
make run_hw GEMX_ddrWidth=16 GEMX_argInstrWidth=1 GEMX_numKernels=1 GEMX_dataType=float GEMX_dataEqIntType=int32_t GEMX_part=vcu1525 GEN_BIN_PROGRAM="pca 0 0 0 8 ../data/spmv/mario001.mtx A0 B0 C0 pca 38496 38496 114648 8 none A0 C0 C1" || exit 1