...
ifeq (${GEMX_part},vu9pf1)
GEMX_fpgaDdrBanks = XCL_MEM_DDR_BANK${K2_DDR},XCL_MEM_DDR_BANK${K1_DDR},XCL_MEM_DDR_BANK${K0_DDR},XCL_MEM_DDR_BANK${K3_DDR}
else
...
GEMX_HOST_LFLAGS = -L$(BOOST_LIB) -L${XILINX_SDX}/lib/lnx64.o -lz -lxilinxopencl -lstdc++ -lrt -pthread
...
clean :
	...
	${RM} -rf ${OUT_HOST_DIR} _xocc_link_gemx_gemx.dir sdaccel_profile* .Xil _sds iprepo bd.* *.bit *.ltx *.dat *.hpfm *.xml _new_clk_freq dr.bd.tcl
